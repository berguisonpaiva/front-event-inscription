    ...
    return (
        ...
        <div className="flex mt-10 flex-row gap-2">
          <button
            ...
            disabled={isLoading}
            className={` ${isLoading ? 'opacity-20' : ''} inline-flex w-full justify-center items-center px-3 py-2 text-sm  text-center text-white font-bold rounded-lg  focus:ring-4 focus:outline-none 
          ...
          className={`inline-flex gap-2 w-full justify-center items-center px-3 py-2 text-sm font-medium text-center ${isLoading ? 'opacity-20' : ''}
          text-white bg-blue-green rounded-lg focus:ring-4 focus:outline-none  bg-slate-600 hover:bg-slate-700 focus:ring-slate-800`}
        >
